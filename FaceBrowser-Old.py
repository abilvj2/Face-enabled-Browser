...
class MainWindow(QMainWindow):
    ...
    def setupLayout(self):
        ...
        self.cef_widget2 = CefWidget(self)
        ...
        tab1.layout.addWidget(self.cef_widget)
        tab1.setLayout(tab1.layout)

        tab2.layout = QVBoxLayout()
        tab2.layout.addWidget(self.cef_widget2)
        ...
        # Browser can be embedded only after layout was set uphidden_window
        self.cef_widget.embedBrowser("https://www.google.com/")
        self.cef_widget2.embedBrowser("https://www.youtube.com/")
...
class NavigationBar(QFrame):
    def __init__(self, cef_widget):
        ...
        self.camera.clicked.connect(self.onCamera)
        # noinspection PyArgumentList
    ...
    def onCamera(self):
        QMessageBox.about(self, "Face Recognition", "Camera will open")
